...
class DiseasePrediction:
    ...
    def _clean_feature_names(self, df):
        """Cleans the feature names by removing extra spaces and standardizing names."""
    ...
    def _load_train_dataset(self):
        ...
        df_train = self._clean_feature_names(df_train)  # Clean the feature names
    ...
    def _load_test_dataset(self):
        ...
        df_test = self._clean_feature_names(df_test)  # Clean the feature names
    ...
    def train_model(self):
        ...
        # Save Trained Model
        joblib.dump(classifier, str(self.model_save_path + self.model_name + ".joblib"))

    # Function to Make Predictions on Test Data
    def make_prediction(self, saved_model_name=None, test_data=None):
        try:
            # Load Trained Model
            clf = joblib.load(str(self.model_save_path + saved_model_name + ".joblib"))
        except Exception as e:
