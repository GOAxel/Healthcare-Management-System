                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            */
                                                // $r="select *from";
                                                $ret="SELECT * FROM  his_app where app_status = 'Accept' and doc_id='$doc_id'"; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="his_doc_view_accepted_appointments.php?cancel=<?php echo $row->app_id;?>" class="badge badge-danger"><i class="mdi  mdi-trash-can-outline"></i> cancel</a>
