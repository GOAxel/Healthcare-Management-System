...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			$query="UPDATE  his_patients  SET pat_fname=?, pat_lname=?, pat_age=?, pat_dob=?, pat_number=?, pat_phone=?, pat_addr=? WHERE pat_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssi', $pat_fname, $pat_lname, $pat_age, $pat_dob, $pat_number, $pat_phone,  $pat_addr, $pat_id);
			$stmt->execute();
			/*
