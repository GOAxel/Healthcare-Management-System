                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" name="pat_phone" placeholder="Patient's Mobile Number"  class="form-control" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Any allergy</label>
                                                    <input required="required" type="text" name="pat_allergy" placeholder="Any allergy"  class="form-control" id="inputCity">
                                                </div>
