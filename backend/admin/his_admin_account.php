<?php
	...
	include('assets/inc/config.php');
        ...
        if(isset($_POST['update_pwd']))
		{
            ...
            $OldPassword=sha1(md5($_POST['ad_old']));

            $query = "SELECT ad_pwd FROM his_admin WHERE ad_id = ?";
            $stmt = $mysqli->prepare($query);
            ...
            {
                if($_POST['ad_pwd']==$_POST['ad_pwd_con'])
                {
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" required="required"  name="ad_fname"  class="form-control" id="firstname" placeholder="<?php echo $row->ad_fname;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">Last Name</label>
                                                                <input type="text" name="ad_lname" required="required" class="form-control" id="lastname" placeholder="<?php echo $row->ad_lname;?>">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" required="required" name="ad_email" class="form-control" id="useremail" placeholder="<?php echo $row->ad_email;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Profile Picture</label>
                                                                <input type="file" required="required" name="ad_dpic" class="form-control btn btn-success" id="useremail" placeholder="<?php echo $row->ad_email;?>">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" name="ad_old"  required="required" class="form-control" id="firstname" placeholder="Enter Old Password">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">New Password</label>
                                                                <input type="password"  required="required" class="form-control" name="ad_pwd" id="lastname" placeholder="Enter New Password">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="ad_pwd_con" required="required" class="form-control" id="useremail" placeholder="Confirm New Password">
                                                    </div>
