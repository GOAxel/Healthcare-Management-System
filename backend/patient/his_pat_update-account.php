<?php
	...
	include('assets/inc/config.php');
        ...
        if(isset($_POST['update_pwd']))
		{
            ...
            $OldPassword=sha1(md5($_POST['pat_Old']));
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" required="required" name="pat_fname"  class="form-control" id="firstname" placeholder="<?php echo $row->pat_fname;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">Last Name</label>
                                                                <input type="text" required="required" name="pat_lname" class="form-control" id="lastname" placeholder="<?php echo $row->pat_lname;?>">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" required="required" name="pat_phone" class="form-control" id="useremail" placeholder="<?php echo $row->pat_phone;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Profile Picture</label>
                                                                <input type="file" required="required"  name="pat_dpic" class="form-control btn btn-success" id="useremail" >
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" name="pat_Old"   required="required" class="form-control" id="firstname" placeholder="Enter Old Password">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">New Password</label>
                                                                <input type="password" required="required"  class="form-control" name="pat_pass" id="lastname" placeholder="Enter New Password">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" required="required" class="form-control" name="pat_pass_con" id="useremail" placeholder="Confirm New Password">
                                                    </div>
