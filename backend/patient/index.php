<?php
    ...
    if(isset($_POST['pat_login']))
    {
        ...
        $stmt=$mysqli->prepare("SELECT pat_number, pat_pass, pat_id FROM his_patients WHERE  pat_number=? AND pat_pass=? ");//sql to log in user
        $stmt->bind_param('ss', $pat_number, $pat_pass);//bind fetched parameters
        $stmt->execute();//execute bind
        $stmt -> bind_result($pat_number, $pat_pass ,$pat_id);//bind result
        $rs=$stmt->fetch();
        $_SESSION['pat_id'] = $pat_id;
        $_SESSION['pat_phone'] = $pat_number;//Assign session to doc_number id
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Enter your UserId and password to access Patient panel.</p>
                                </div>

                                <form method='post' >

                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Patient UserId</label>
                                        <input class="form-control" name ="pat_number" type="text" id="emailaddress" required="" placeholder="Enter your Patient UserId">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="his_doc_reset_pwd.php" class="text-white-50 ml-1">Forgot your password?</a>
                                <a href="../../index.php" class="text-white-50 ml-1">go to Home?</a>
                            </p>
                            <a href="his_pat_register_patient.php" class="text-white-50 ml-1">create new account</a>
